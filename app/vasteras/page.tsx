          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p className="text-justify">
                ...
                Do you live in or around central Västerås, Or do you live a bit outside? No matter where in Västerås you live, as a customer of Amples you always pay the same fixed price per square meter for moving cleaning.
              </p>
              <p className="text-justify">
