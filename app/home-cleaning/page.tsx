          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4">
                At Amples, we understand that your home is your sanctuary. Our comprehensive home cleaning services are designed to give you more time to enjoy the things you love while we handle the cleaning with professionalism and care.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Our experienced team uses eco-friendly products and proven techniques to ensure every surface in your home is spotless and sanitized.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-cyan-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-cyan-600 mb-2">✓ Customizable</h4>
