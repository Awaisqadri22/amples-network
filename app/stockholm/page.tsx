          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p className="text-justify">
                ...
                Do you live in or around central Stockholm, e.g. in <strong>Solna</strong>, <strong>Nacka</strong>, <strong>Sundbyberg</strong>? Or do you live a bit outside? Like in e.g. <strong>Täby</strong>, <strong>Sollentuna</strong>, <strong>Huddinge</strong> or <strong>Haninge</strong>? No matter where in Stockholm you live, as a customer of Qleano you always pay the same fixed price per square meter for moving cleaning.
              </p>
              <p className="text-justify">
