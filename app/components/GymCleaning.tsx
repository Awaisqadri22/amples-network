...
const services = [
  ...
  { name: 'Gym Cleaning', href: '/gym-cleaning', icon: '💪', active: true }
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl">
              Professional gym cleaning services to maintain a hygienic, safe, and welcoming fitness environment
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-lg text-gray-600 mb-4">
                At Amples, we understand that gyms require specialized cleaning to maintain hygiene and safety standards. Our comprehensive gym cleaning services are designed to keep your fitness facility spotless, sanitized, and welcoming for all members.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Our experienced team uses hospital-grade disinfectants, specialized equipment, and proven techniques to ensure every surface, from exercise equipment to locker rooms, is thoroughly cleaned and sanitized to prevent the spread of germs and bacteria.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-cyan-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-cyan-600 mb-2">✓ Sanitized</h4>
                  <p className="text-sm text-gray-600">Hospital-grade cleaning</p>
                </div>
                <div className="bg-emerald-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-emerald-600 mb-2">✓ Eco-Friendly</h4>
                  <p className="text-sm text-gray-600">Safe for members</p>
                </div>
                <div className="bg-cyan-50 p-4 rounded-lg">
            ...
            <div className="lg:col-span-3">
              <QuoteForm idPrefix="gym-cleaning" />
            </div>
          </div>
        </div>
      </section>
