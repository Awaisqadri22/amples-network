...
const services = [
  ...
  { name: 'Office Cleaning', href: '/office-cleaning', icon: '🏢', active: true },
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl">
              Professional office cleaning services to maintain a clean, healthy, and productive work environment
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-lg text-gray-600 mb-4">
                At Amples, we understand that a clean office environment is essential for productivity, employee well-being, and creating a positive impression for clients. Our comprehensive office cleaning services are designed to keep your workspace spotless, sanitized, and professional.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Our experienced team uses eco-friendly products and proven techniques to ensure every area of your office, from workstations to common areas, is maintained to the highest standards of cleanliness.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-cyan-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-cyan-600 mb-2">✓ Flexible</h4>
                  <p className="text-sm text-gray-600">After-hours service</p>
                </div>
                <div className="bg-emerald-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-emerald-600 mb-2">✓ Eco-Friendly</h4>
                  <p className="text-sm text-gray-600">Safe for employees</p>
                </div>
                <div className="bg-cyan-50 p-4 rounded-lg">
            ...
            <div className="lg:col-span-4">
              <ContactForm defaultService="Office Cleaning" />
            </div>
          </div>
        </div>
      </section>
