...
const services = [
  ...
  { name: 'Construction Cleaning', href: '/construction-cleaning', icon: '🔨', active: true },
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl">
              Comprehensive post-construction cleaning services to prepare your space for occupancy
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-lg text-gray-600 mb-4">
                At Amples, we understand that construction sites require specialized cleaning expertise. Our comprehensive construction cleaning services are designed to transform your newly built or renovated space into a spotless, move-in-ready environment.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Our experienced team uses industrial-grade equipment, specialized cleaning solutions, and proven techniques to remove construction debris, dust, paint splatters, and all traces of the building process, ensuring your space is pristine and ready for use.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-cyan-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-cyan-600 mb-2">✓ Comprehensive</h4>
                  <p className="text-sm text-gray-600">Complete cleanup</p>
                </div>
            ...
            <div className="lg:col-span-3">
              <QuoteForm idPrefix="construction-cleaning" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-cyan-500 to-emerald-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Clean Your Construction Site?
          </h2>
