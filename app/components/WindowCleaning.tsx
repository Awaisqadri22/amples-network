...
const services = [
  ...
  { name: 'Window Cleaning', href: '/window-cleaning', icon: '🪟', active: true },
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl">
              Crystal-clear window cleaning services for spotless, streak-free windows that let the light shine through
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-lg text-gray-600 mb-4">
                At Amples, we understand that clean windows are essential for both the appearance and ambiance of your space. Our comprehensive window cleaning services are designed to leave your windows crystal clear, streak-free, and sparkling.
              </p>
              <p className="text-lg text-gray-600 mb-4">
                Our experienced team uses professional-grade equipment, eco-friendly cleaning solutions, and proven techniques to ensure every window, both interior and exterior, is spotless and allows maximum natural light to brighten your space.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="bg-cyan-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-cyan-600 mb-2">✓ Streak-Free</h4>
                  <p className="text-sm text-gray-600">Crystal clear results</p>
                </div>
            ...
            <div className="lg:col-span-4">
              <ContactForm defaultService="Window Cleaning" />
            </div>
          </div>
        </div>
      </section>
