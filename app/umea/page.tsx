...
export default function UmeaPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar />
      <Breadcrumb cityName="Umeå" />

      {/* Banner Section */}
      <section className="relative h-[400px] md:h-[500px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-emerald-500 to-cyan-600">
          <div className="absolute inset-0 bg-[url('/umea.webp')] bg-cover bg-center mix-blend-overlay"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-100 max-w-2xl">
              Professional cleaning services in Umeå
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Moving cleaning in Umeå
            </h2>
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p className="text-justify">
                Are you looking for moving cleaning in Umeå at a good price?
                Do you live in or around central Umeå, e.g. in <strong>Solna</strong>, <strong>Nacka</strong>, <strong>Sundbyberg</strong>? Or do you live a bit outside? Like in e.g. <strong>Täby</strong>, <strong>Sollentuna</strong>, <strong>Huddinge</strong> or <strong>Haninge</strong>? No matter where in Umeå you live, as a customer of Qleano you always pay the same fixed price per square meter for moving cleaning.
              </p>
              <p className="text-justify">
                Our cleaning companies in Umeå have good reviews from our customers and all our collaborations are continuously evaluated by us based on high-level goals for quality and customer satisfaction.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              What is included in a moving cleaning in Umeå?
            </h2>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-200">
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                Any additional spaces and options, as well as whether or not they will affect your final price, you will see in the booking form safely and securely before you book your moving cleaning in Umeå.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed text-justify mt-4">
                If you want to know more, we recommend that you read about the <strong>requirements for moving house cleaning</strong>. You can also read our <strong>complete moving house cleaning checklist</strong> and what is included in a moving house cleaning in Umeå.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-emerald-50 rounded-xl p-8 border-2 border-cyan-200">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                Tips and preparations for your moving cleaning in Umeå:
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We always aim for 100% satisfied customers. That&apos;s why as a customer in Umeå you have a quality guarantee with us for 14 days.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We evaluate our collaborations with local cleaning companies in Umeå on an ongoing basis with a focus on quality and customer satisfaction.
              </p>
            </div>
          </div>
        </div>
